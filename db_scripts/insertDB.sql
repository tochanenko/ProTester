...
VALUES ('login_dataset', 'dataset for login');

INSERT INTO "data_set_parameters"(data_set_id, data_set_key, data_set_value)
VALUES ((SELECT data_set_id
    FROM data_sets
    WHERE data_set_name = 'login_dataset'), 'login', 'admin'),
       ((SELECT data_set_id
         FROM data_sets
         WHERE data_set_name = 'login_dataset'), 'password', '12345');
